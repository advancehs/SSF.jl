...
function getRII(::Type{SMAH}, PorC::Int64, pos::NamedTuple, coef::Array{Float64, 1}, 
  Ỹ::Vector, X̃::Matrix, z, Q::Matrix, u, v,  WA::Matrix,  idt::Matrix{Any})
...
function getRII(::Type{SART}, PorC::Int64, pos::NamedTuple, coef::Array{Float64, 1}, 
  Ỹ::Vector, X̃::Matrix, z, Q::Matrix, u, v,  WA::Matrix,  idt::Matrix{Any})
...
function getRII(::Type{SARH}, PorC::Int64, pos::NamedTuple, coef::Array{Float64, 1}, 
Ỹ::Vector, X̃::Matrix, z, Q::Matrix, u, v,  WA::Matrix,  idt::Matrix{Any})
